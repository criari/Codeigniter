                ...
                <div class="table-container">
                    <?php echo form_open("", 'method="post" autocomplete="off" id="gcrud-search-form"'); ?>
                        ...
                        <div class="scroll-if-required">
        					...
        					<thead>
        						<tr>
        							<th colspan="1" <?php if ($buttons_counter === 0) {?>class="hidden"<?php }?>></th>
                                    <?php foreach($columns as $column){?>
                                        <th class="column-with-ordering" data-order-by="<?php echo $column->field_name; ?>"><?php echo $column->display_as; ?></th>
                                    <?php }?>
                                    <th colspan="1" <?php if ($buttons_counter === 0) {?>class="hidden"<?php }?>>
                                        <?php echo $this->l('list_actions'); ?>
                                    </th>
        						</tr>
        						
        						<tr class="filter-row gc-search-row search-row">
                                    ...
                                    <?php foreach($columns as $column){ ?>
                                        <td>
                                            <input type="text"
                                                   ...
                                                   name="<?php if($column->relation_field != null) { echo $column->relation_field; }else{ echo $column->field_name; } ?>" />
                                        </td>
                                    <?php }?>
